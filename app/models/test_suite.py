...
class TestSuiteDocument(modb.BaseDocument):
    ...
    def __init__(self, name, lab_name, build_id=None, build_type=None, version="1.0"):
    ...
    def from_json(json_obj):
        ...
        if isinstance(json_obj, types.DictionaryType):
            ...
            try:
                ...
                #build_type = doc_pop.get(models.BUILD_TYPE_KEY, None)
                build_type = doc_pop(models.BUILD_TYPE_KEY)
